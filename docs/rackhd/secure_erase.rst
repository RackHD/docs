...
RackHD workflow supports disk Secure Erase (SE).

Supported Disk Secure Erase Tools
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^

RackHD currently supports disk secure erase with four tools: scrub, hdparm, sg_sanitize, sg_format. Below table includes description for different tools.
============= ===============================================================================================================
Tool          Description          
============= ===============================================================================================================
...
Secure erase usually takes hours or even several days to complete, you can use below command to check the workflow is active or inactive:
...
Stop the active workflow to cancel secure erase workflow:
...
All parameters descriptions of secure workflow payload are listed below.
...
=========== ======================= ============================================
Tool        Supported args          Description
=========== ======================= ============================================
scrub       nnsa                    4-pass NNSA Policy Letter NAP-14.1-C (XVI-8) for sanitizing removable and non-removable hard disks, which requires overwriting all locations with a  pseudo‐random pattern twice and then with a known pattern: random(x2), 0x00, verify. scrub default arg=nnsa
...
=========== ======================= ============================================
hdparm      security-erase          Issue ATA Secure Erase (SE) command. hdparm default arg="security-erase"
...
=========== ======================= ============================================
sg_sanitize block                   Perform a "block erase" sanitize operation. sg_sanitize default arg="block"
            fail                    Perform an "exit failure mode" sanitize operation.
            crypto                  Perform a "cryptographic erase" sanitize operation.
=========== ======================= ============================================
sg_format   "1"                     Disable Glist erasing. sg_format default arg="1
