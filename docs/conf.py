# -*- coding: utf-8 -*-
#
# RackHD documentation build configuration file, created by
...
man_pages = [
    (master_doc, 'rackhd', u'RackHD Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'RackHD', u'RackHD Documentation',
   author, 'RackHD', 'One line description of project.',
   'Miscellaneous'),
]
